...
function year1803() {
    document.getElementById('diffImage').src = 'images/Louisiana-Purchase-size.webp'
    document.getElementById('change-paragraph').innerText = "The Louisiana Purchase was a historic event in which the United States acquired approximately 827,000 square miles of land west of the Mississippi River from France for $15 million in 1803. This doubled the size of the country and included land that eventually became parts of 15 states."
    document.getElementById('changeDate').innerText = 'October 20th, 1803'
}
function year1964() {
...
function year1979() {
    document.getElementById('diffImage').src = 'images/reeds.webp'
    document.getElementById('change-paragraph').innerText = 'John Krasinski (born October 20, 1979, Newton, Massachusetts, U.S.) American actor and director best known for playing paper salesman Jim Halpert in the NBC sitcom The Office.'
    document.getElementById('changeDate').innerText = 'October 20th, 1979'
}